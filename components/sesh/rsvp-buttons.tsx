      ...
      <div className="flex gap-2">
        {approved ? (
          <button
            ...
            value="kicked"
            disabled={pending}
            className="min-h-11 rounded-control bg-surface-2 px-3 py-2 text-sm text-danger disabled:opacity-50"
          >
            Remove
          </button>
        ) : (
          <>
            <button
              ...
              value="approved"
              disabled={pending}
              className="min-h-11 rounded-control bg-primary px-3 py-2 text-sm font-semibold text-on-primary disabled:opacity-50"
            >
              Approve
            </button>
            <button
              ...
              value="denied"
              disabled={pending}
              className="min-h-11 rounded-control bg-surface-2 px-3 py-2 text-sm text-ink disabled:opacity-50"
            >
              Decline
            </button>
          </>
