...
| 04b | none — app foundations: the Frame, missing routes, settings, mobile | GitHub issue #59 | Grilled and spec'd 2026-09-22. Setup (#60) done 2026-09-23: `PRODUCT.md`, `DESIGN.md`, the Frame/Me shape brief in `.impeccable/surfaces/route-me.md`, spec §5, §7.1 Mobile and the v2 list. The rest not built. **Runs before 05** |
