...
const SERVER_MODULES =
  /^import (?!type )[^;]*from ["']@\/lib\/(server-env|derived-keys|supabase\/admin|verification\/(image-crypto|challenge-token|limits|vision|store|submit|owner-alert|reaper)|member\/expiry-sweep|email)["']/m;
